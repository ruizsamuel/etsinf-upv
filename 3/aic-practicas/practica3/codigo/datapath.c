...
void dibuja_datapath() {
    ...
    if latencia_salto1(solucion_riesgos_control) {
        ...
        genera_latch6(&RegEX_M, EXM_x, EXM_y, reg_ancho, reg_alto, zeroEX.out1.y, RegID_EX.out2.y, alu_EX.out1.y,
                      RegID_EX.out5.y - sep1y, 0, RegID_EX.out6.y, "EX_M", "", "npc", "ALUout", "B", "", "IR", "red",
                      "gray", "lightgray");
    }
    ...
    if latencia_salto3(solucion_riesgos_control) {
        ...
        // EX_M, con cond
        genera_latch6(&RegEX_M, EXM_x, EXM_y, reg_ancho, reg_alto, zeroEX.out1.y, RegID_EX.out2.y, alu_EX.out1.y,
                      RegID_EX.out5.y - sep1y, 0, RegID_EX.out6.y, "EX_M", "cond", "npc", "ALUout", "B", "", "IR",
                      "red", "gray", "lightgray");
        // Zero Cmp -> EX_M.cond
...
// mux ALUs
    ...
    if latencia_salto3(solucion_riesgos_control) {
        ...
        conecta_p1_dx1_y_dx2_p2(RegEX_M.out1, mux2_pc.ctrl, sep1x, RegEX_M.pos1.y - 4 * sep1y, 0, col_M);
