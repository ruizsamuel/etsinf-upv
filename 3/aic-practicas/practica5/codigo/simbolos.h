 ...
 *
 * @brief
 *    Contiene las definiciones asociadas a la tabla de símbolos
 *
...
#define te_etiqueta(str, dir) ts_simbolo_direccion(programa.simbolos, (dir), (str), FLAG(etiquetas))
#define te_etiqueta_desp(str, dir) ts_simbolo_direccion(programa.simbolos, (dir), (str), SI)
