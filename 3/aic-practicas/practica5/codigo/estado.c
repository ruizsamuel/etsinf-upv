 ...
 *
 * @brief
 *    Una tabla hash para mantener el estado previo.
 *    Se utiliza para el formato JSON que es incremental.
 *
 ...
 * @param table_state
 * @param key
 * @return An existing value, NULL otherwise
 */
