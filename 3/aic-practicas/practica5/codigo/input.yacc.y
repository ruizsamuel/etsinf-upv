...
%type <ivalue> r_inmediato_hi r_inmediato_disp r_posicion_hi r_posicion r_posicion_larga r_offset
...
| T_ALPHANUM
{
    sprintf(desplazamiento,"%%pcrel_hi(%s)",$1);
    ts_inserta_referencia(ts, $1, region, pos[region], PC_REL_HI_20, tr_code);
    $$ = 0; // Referencia por resolver
}
;
...
// auipc x, posicion_hi
| FORM_INT_RA REG_INT ',' r_posicion_hi
{
    nueva_instruccion($1, FormatoU, $2, 0, 0, 0, $4, desplazamiento, 0);
}
